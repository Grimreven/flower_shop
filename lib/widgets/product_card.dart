...
class ProductCard extends StatelessWidget {
  ...
  Future<void> _showCartAuthDialog(BuildContext context) async {
  ...
  Future<void> _showFavoriteAuthDialog(BuildContext context) async {
    await AppAuthRequiredDialog.show(
      context,
      title: 'Требуется вход',
      message:
      'Чтобы добавить товар в избранное, пожалуйста, авторизуйтесь или зарегистрируйтесь.',
      confirmText: 'Войти',
    );
  }
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  if (!resolvedAuthController.isLoggedIn) {
                                    await _showFavoriteAuthDialog(context);
                                    return;
                                  }
                  ...
                  children: [
                    ...
                    Obx(() {
                      final bool isLoggedIn =
                          resolvedAuthController.isLoggedIn;
                        ...
                        return SizedBox(
                          ...
                          child: DecoratedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                await _showCartAuthDialog(context);
                              },
